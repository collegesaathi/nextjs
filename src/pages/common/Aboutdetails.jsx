                ...
                <div className="max-w-[1100px]">
                    <div className=" ">
                        ...
                        <p className="font-poppins font-[400] text-[17px] leading-[25px] text-[#282529]">
                            ...
                            <span className="font-[600]">NMIMS CDOE</span> provides an online
                            ...
                            <span className="font-[600]">NMIMS is famous</span> for its variety
                            ...
                            <span className="font-[600]">NMIMS CDOE</span> has emerged as a
                            leading institution of choice for distance and online education in
                            India. With an advanced learning platform,{" "}
                            <span className="font-[600]">NMIMS CDOE</span> is the best choice
                            for students.
                        </p>
