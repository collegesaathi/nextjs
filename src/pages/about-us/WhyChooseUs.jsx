      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="space-y-12 relative">
            ...
            <div className="w-full h-96 rounded-2xl bg-yellow-50/50 shadow-lg p-8">
            </div>
          ...
          <div className="lg:pt-20 space-y-8">
            ...
            <div className="pt-4">
              <a 
                href="/careers" 
                className="inline-flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-lg shadow-sm text-white bg-red-600 hover:bg-red-700 transition duration-150 ease-in-out"
              >
                Explore Careers
              </a>
            </div>
