    ...
    return (<>
        <AdminLayout>
            <div className="min-h-screen p-1 ">
                ...
                <div className="py-4 lg:py-[13px] px-4 md:px-6 lg:px-10 flex flex-wrap justify-between items-center border-b border-black  border-opacity-10 bg-[#000000]">

                    {/* Center Heading */}
                    <h3 className="flex items-center gap-2 text-[18px] lg:text-[20px] font-[600] font-[Poppins] text-[#151D28] tracking-[-0.03em]">
                        <FaArrowLeft
                            onClick={handleBack}
                            className={`cursor-pointer ${currentIndex === 0 ? "text-gray-300 cursor-not-allowed" : "text-[#151D28] hover:text-blue-600"
                                }`}
                        />
                    ...
                    <div className="flex flex-wrap justify-center bg-[#DADADA] gap-2 rounded-lg p-1  mb-3 md:mb-0 mt-3 md:mt-0 ">
                        {tabsData.map((tab) => (
                            <button
                                key={tab.id}
                                onClick={() => setActiveTab(tab.id)}
                                className={`px-4 py-2 rounded-lg font-[400] font-[poppins] text-sm transition-all duration-200 
        ${activeTab === tab.id
                                        ? "bg-[#E9E9E9] text-black shadow-sm"
                                        : "text-[#3E3E3E] font-[Poppins] hover:bg-[#E9E9E9] hover:text-black"
                                    }`}
                            >
                                {tab.label}
                            </button>
                        ...
                        <>
                            ...
                            {faqs.map((faq, index) => (
                                <div key={index} className="grid grid-cols-1 gap-4 items-center">
                                    <div>
                                        <label className="block text-[#CC2828] font-medium mb-2">Advantages</label>
                                        <input
                                            type="text"
                                            disabled={faq?._id}
                                            value={faq.question}
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            placeholder="Enter Advantages Description"
                                            className="w-full bg-[#F4F6F8] text-[#727272] border border-[#F4F6F8] rounded-[10px] px-4 py-2 focus:outline-none"
                                        />
                                    </div>
                                </div>
                ...
                <div className="flex justify-between mt-8  p-6">
                    <button
                       ...
                       ${currentIndex === 0
                                ...
                                : "bg-gray-200 text-[#3E3E3E] hover:bg-gray-300"
                            }`}
                    >
                        <FaArrowLeft /> Back
                    </button>
