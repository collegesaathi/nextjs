...
function OpenPositions() {
    return (
        <section className="py-10 md:py-10 bg-[#F4F5F6] font-poppins">
                        ...
                        <div key={index}>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {category.jobs.map((job, jIndex) => (
                                    <div key={jIndex} className="bg-[#FFFCFA] p-4 rounded-lg  border border-gray-100 hover:shadow-md transition-shadow cursor-pointer">
