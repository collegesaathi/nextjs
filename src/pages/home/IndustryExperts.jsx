...
const expertsData = [
  ...
  { name: "Anil Kamboj", role: "Senior Specialist", quote: "As a technical professional with more than 15 years of experience in the WASH sector, I was founded to enhance my skills...", imageUrl: "/images/anil-kamboj.png", isSenior: true },
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 md:p-8 bg-white shadow-2xl rounded-xl">
      ...
      <Swiper
        ...
        className="pb-10" // Padding for pagination dots below the content
      >
        {expertSlides.map((slideExperts, index) => {
          // SlideExperts contains 4 experts: [0, 1] for left, [2, 3] for right
          const leftColumnExperts = [slideExperts[0], slideExperts[1]];
          const rightColumnExperts = [slideExperts[2], slideExperts[3]];
          return (
            <SwiperSlide key={index}>
              {/* This div is the ENTIRE content of a single slide */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                
                {/* Left Column (Expert Cards 1 and 2) */}
                ...
                {/* Right Column (Expert Cards 3 and 4 & Button) */}
