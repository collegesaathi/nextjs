...
export default function Index() {
  ...
  return (
    <>
      ...
      <Popup isOpen={IsOpen} onClose={() => setIsOpen(false)} size={"max-w-full"} height={"max-h-full"} bg={"bg-[rgba(252,214,214,1)]"}>
        <div className="w-full flex flex-col justify-center items-center py-6 px-4 my-[24px] ">
