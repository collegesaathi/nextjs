...
function Index() {
    ...
    return (<>
        ...
        <Head>
            <title>Contact Collegesathi | Online Course Guidance & Support</title>
            <meta
                name="description"
                content="Get in touch with Collegesathi for guidance on online MBA, BBA, BCA & MCA programs. Our experts are here to help."
            />
                ...
                <section className="relative w-full py-8 md:py-16 md:px-4 ">
                    ...
                    <div className="relative z-10 flex flex-col items-center text-center">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mt-6 md:mt-12 w-full" >
                            ...
                            {/* Support */}
                         <div 
  className="group bg-white border border-[#DFDFDF] rounded-2xl p-6 flex flex-col gap-3 hover:shadow-lg cursor-pointer transition font-poppins" 
        ...
        <div className="flex flex-col justify-start items-start gap-2">
            ...
            <a href="mailto:support@collegesathi.com" className="text-[#ED1F24] font-[400] font-poppins text-[15px] underline">
                support@collegesathi.com
                            ...
                            <div className=" group bg-white border border-[#DFDFDF] rounded-2xl  p-6 flex flex-col gap-3 hover:shadow-lg cursor-pointer  transition font-poppins" onClick={() => setActive("hr")}>
                                <div className="flex flex-col justify-start items-start md:gap-10 gap-6 ">
                            ...
                            <div className=" group bg-white border border-[#DFDFDF] rounded-2xl  p-6 flex flex-col gap-3 hover:shadow-lg cursor-pointer transition font-poppins" onClick={() => setActive("DM")}>
                                <div className="flex flex-col justify-start items-start md:gap-10 gap-6 ">
                            ...
                            <div className=" group bg-white border border-[#DFDFDF] rounded-2xl  p-6 flex flex-col gap-3 hover:shadow-lg cursor-pointer  transition font-poppins" onClick={() => setActive("Call")}>
