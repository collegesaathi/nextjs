...
export default function ProgramCareer({ setCareers, Careers, htitle, formData, handleQuillChange, handleChange }) {
    ...
    return (
        <div>
            ...
            {Careers?.map((adv, index) => (
                <div key={index} className="grid grid-cols-3     gap-4 mb-6 border-b border-gray-200 pb-4">

                    {/* Title */}
                    <div>
                        <label className="block text-[#CC2828] font-medium mb-2">Job Positions</label>
                        <input
                            type="text"
                            value={adv.title}
                    ...
                    <div>
                        <label className="block text-[#CC2828] font-medium mb-2">Accreditations</label>
                        <input
                            type="text"
                            value={adv.desc}
                            onChange={(e) => handleAdvantageChange(index, "desc", e.target.value)}
