...
export default function AddDuration({ setDuration, Duration, htitle, formData, handleQuillChange, handleChange }) {

    // Add new advantage
    const addAdvantage = () => {
        setDuration([...Duration, { title: "", description: "", }]);
    };
    ...
    return (
        <div>
            ...
            <div className="mt-5 mb-5">
                <ReactQuillEditor
                    label="Description"
                    desc={formData.durationdesc}
                    handleBioChange={(val) => handleQuillChange("durationdesc", val)}
                />
            </div>
            {/* Header + Add Button */}
            <div className="flex justify-between items-center mb-5">
                <h2 className="text-xl font-semibold text-[#CC2828]">{htitle || "Duration"} Section</h2>
                <button
                    type="button"
